    ...
    <Grid>
     ...
     <Table.Header>
       <Table.Row>
         ...
         <Table.HeaderCell>21 Freedom Street, Atlanta, GA, USA</Table.HeaderCell>
       </Table.Row>
     </Table.Header>
     <Table.Header>
       <Table.Row>
         ...
         <i>"Dedicated Primary School Teacher with 9 years of experience teaching across KS1 ans KS2 with a proven ability to create a positive and imaginative learning environment for pupils"</i>       
         <br/><br/>
         <Label as='a' color='orange' ribbon>
           Outline
         </Label><br/><br/>
 
         <i>"Taught the KS2 Year 6 class of pupils in an OFSTED rated 'Good' school based in Atlanta. Responsible for developing a healthy, positive learning environment for pupils."</i>       
